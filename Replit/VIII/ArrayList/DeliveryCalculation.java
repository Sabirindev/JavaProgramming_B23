...
public class DeliveryCalculation {
    ...
    public static int refuel_times(ArrayList<Integer> deliveries, int max_fuel){
        ...
        int totalTimesForRefueling = 0;

        for (Integer fuelUnitNeeded : deliveries) {
            if (fuelUnitNeeded >= max_fuel){
                totalTimesForRefueling += fuelUnitNeeded/max_fuel;
            }else {
                totalTimesForRefueling += 1;
            }
        }

        return totalTimesForRefueling;
    }
}
/*
