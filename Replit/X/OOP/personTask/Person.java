...
public class Person {
    ...
    public Person() { //constructor without parameter

        setFirstName("undefined");//firstName = "undefined";
        setLastName("undefined");//lastName = "undefined";
        setAge(-1);//age = -1;
    }

    public Person(String firstName, String lastName, int age) { ////constructor with parameter
