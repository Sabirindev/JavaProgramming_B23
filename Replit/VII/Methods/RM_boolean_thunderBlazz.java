...
public class RM_boolean_thunderBlazz {
    public static void main(String[] args) {
        Scanner scan = new Scanner(System.in);
        System.out.println(getThunderBlazz(scan.hasNextBoolean(),scan.hasNextBoolean(),
...
/*
There are a few ways to get this galactically popular drink, if its available at the store you can buy it.
